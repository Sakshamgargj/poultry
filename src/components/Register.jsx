...
function RegisterPage() {
    return (
        <div className="flex justify-center items-center min-h-screen pt-20 bg-gray-100 p-4">
            <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md border">
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-gray-600 text-sm">I agree to the <a href="#" className="text-blue-600 hover:underline">terms and conditions</a></span>
                    </div>
                    <button className="w-full bg-green-600 text-white py-2 rounded-md font-bold hover:bg-green-700">Register</button>
                </form>
